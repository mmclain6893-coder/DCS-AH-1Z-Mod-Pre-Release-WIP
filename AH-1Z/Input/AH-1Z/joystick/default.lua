...
-- Systems
	...
	{down = EFM_commands.trimSave, name = _('Force Trim Button - Set Cyclic and Pedals'), category = _('Flight Control')},
-- Gun turret
...
--{down = iCommandPlaneDropChaffOnce, name = _('Countermeasures Chaff Dispense'), category = _('Countermeasures') , features = {"Countermeasures"}},
	--{down = Keys.PlaneDropChaffOnce, name = _('Chaff Dispense'), category = _('Countermeasures')},
	--{down = Keys.PlaneDropFlareOnce, name = _('Flares Dispense'), category = _('Countermeasures')},
