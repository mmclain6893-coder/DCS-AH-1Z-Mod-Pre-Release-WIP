...
-- Systems
	...
	{combos = {{key = 'T'}}, down = EFM_commands.trimSave, name = _('Force Trim Button - Set Cyclic and Pedals'), category = _('Flight Control')},
	...
	{combos = {{key = 'D',  reformers = {'LWin'}}}, down = Keys.Opendoor,  name = _('Door Open/Close'), category = _('General')},
...
--{combos = {{key = 'Insert'}}, down = iCommandPlaneDropChaffOnce, name = _('Countermeasures Chaff Dispense'), category = _('Countermeasures') , features = {"Countermeasures"}},
   -- {combos = {{key = 'Insert'}}, down = 358, name = _('Chaff Dispense'), category = _('Countermeasures')},
	-- {combos = {{key = 'Delete'}}, down = 357, name = _('Flares Dispense'), category = _('Countermeasures')},
...
----------------------------------- from common_keyboard_binding.lua   ------------------------------------------------------------
	...
	{combos = {{key = 'F12', reformers = {'RCtrl'}}}, down = Keys.HintsOff, name = _('Hints'), category = _('Labels')},
