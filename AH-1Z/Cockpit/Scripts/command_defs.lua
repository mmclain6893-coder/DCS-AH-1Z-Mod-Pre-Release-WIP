...
device_commands = { -- commands for lua
	...
	PilotMFDLeftFLT		= counter();
	PilotMFDLeftMAP		= counter();
	PilotMFDLeftWPN		= counter();
	PilotMFDLeftCOM		= counter();
	PilotMFDLeftSYS		= counter();
	PilotMFDLeftTDC		= counter();
	PilotMFDLeftWCA		= counter();
	PilotMFDLeftEW		= counter();
	PilotMFDLeftTCC		= counter();
	PilotMFDRightFLT	= counter();
	PilotMFDRightMAP	= counter();
	PilotMFDRightWPN	= counter();
	PilotMFDRightCOM	= counter();
	PilotMFDRightSYS	= counter();
	PilotMFDRightTDC	= counter();
	PilotMFDRightWCA	= counter();
	PilotMFDRightTSS	= counter();
	PilotDFDFLT			= counter();
	--CHAFFFIRE		= counter();
	--FLAREFIRE		= counter();
}
