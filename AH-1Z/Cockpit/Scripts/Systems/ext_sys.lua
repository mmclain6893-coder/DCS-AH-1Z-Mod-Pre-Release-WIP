...
local pitch = sensor_data:getStickPitchPosition() / 100--Parkposition
local roll = sensor_data:getStickRollPosition() / 100--Parkposition
...
local GUNNER = get_aircraft_draw_argument_value(39)
local ROTOR = get_aircraft_draw_argument_value(40)
