...
local orange_mat   	= MakeMaterial("",{0,0,0,0})
...
name_t		= {"PILOT","LH GUNNER","BK GUNNER"}
...
function add_crew_member(member)
	...
	txt_burst.init_pos		= {0.57, Y_space}
...
local Key_pos_x = size_X * 0.78

txt_Gunner_Key					= CreateElement "ceStringPoly"
txt_Gunner_Key.name				= "txt_Gunner_Key"
txt_Gunner_Key.material			= "font_hints_kneeboard_keys"
txt_Gunner_Key.init_pos			= {Key_pos_x, 0.0}
txt_Gunner_Key.value			= "LC+LW+4"
txt_Gunner_Key.alignment		= "LeftTop"
txt_Gunner_Key.parent_element	= "txt_mem1"
txt_Gunner_Key.stringdefs		= predefined_font_0
txt_Gunner_Key.controllers		= {{"show_member",3}}
AddElement(txt_Gunner_Key)

txt_BkGunner_Key				= CreateElement "ceStringPoly"
txt_BkGunner_Key.name			= "txt_BkGunner_Key"
txt_BkGunner_Key.material		= "font_hints_kneeboard_keys"
txt_BkGunner_Key.init_pos		= {Key_pos_x, 0.0}
txt_BkGunner_Key.value			= "LC+5"
txt_BkGunner_Key.alignment		= "LeftTop"
txt_BkGunner_Key.parent_element = "txt_mem2"
txt_BkGunner_Key.stringdefs		= predefined_font_0
txt_BkGunner_Key.controllers	= {{"show_member",4}}
AddElement(txt_BkGunner_Key)
